# print("02.31 PM - You: Oh no, that's horrible, how did a whole bookcase fall on them?")

# conversation with charlotte: is it murder?

input()
print("02.31 PM - Lotte: Well, if you push hard enough I'm sure you'll get them to collaps")
input()
